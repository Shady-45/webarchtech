        ...
        <div className="details mt-[-5rem] flex flex-col lg:flex lg:flex-row 2xl:flex 2xl:flex-row ">
          ...
          <div className="details-1">
            <ol>
              ...
              <li>
                <p>
                  <span>2</span> We adapt our services to the problem we’re
                  solving.
                </p>
              </li>
              <hr className="bg-black sm:bg-black  md:hidden lg:hidden 2xl:hidden " />
              <li>
                <p>
                  <span>3</span> And we design in constant cycles of iteration,
                  until we arrive at the best possible solution.
                </p>
              </li>
              <hr className="bg-black sm:bg-black  md:hidden lg:hidden 2xl:hidden " />
            </ol>
